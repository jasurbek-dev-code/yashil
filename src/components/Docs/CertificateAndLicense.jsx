      ...
      <div className="relative z-10 bg-white dark:bg-[#0f1a0f] backdrop-blur-md rounded-2xl shadow-xl max-w-[1200px] mx-auto overflow-hidden">
        ...
        <div className="flex justify-between items-center px-6 py-4 border-b border-gray-300 dark:border-gray-600">
          <h1 className="text-xl font-bold text-gray-800 dark:text-white">
            Loyiha institutining guvoxnoma va litsensiyasi
          </h1>
        </div>
        ...
        <div className="overflow-x-auto px-4 my-5">
          <table className="min-w-full text-sm text-gray-800 dark:text-gray-200">
            <thead>
              <tr>
                <th className="text-center px-6 py-5 font-bold bg-gray-100 dark:bg-[#1a1a1a] border border-gray-300 dark:border-gray-600 rounded-tl-lg">Shifr</th>
                <th className="text-center px-6 py-5 font-bold bg-gray-100 dark:bg-[#1a1a1a] border border-gray-300 dark:border-gray-600">Nomi</th>
                <th className="text-center px-6 py-5 font-bold bg-gray-100 dark:bg-[#1a1a1a] border border-gray-300 dark:border-gray-600 rounded-tr-lg">Fayl</th>
              </tr>
            </thead>
            <tbody>
              {Array.from({ length: 6 }).map((_, i) => (
                <tr key={i}>
                  <td className="text-center px-6 py-4 bg-white dark:bg-transparent border border-gray-300 dark:border-gray-600 rounded-bl-lg shadow-sm">
                    SHNK 12341244
                  </td>
                  <td className="px-6 py-4 bg-white dark:bg-transparent border border-gray-300 dark:border-gray-600 shadow-sm">
                    Buxgalteriya hisobi va hisobot bo‘limi – Bosh buxgalter
                  </td>
                  <td className="text-center px-6 py-4 bg-white dark:bg-transparent border border-gray-300 dark:border-gray-600 rounded-br-lg shadow-sm">
        ...
        <div className="flex justify-between text-gray-500 dark:text-gray-400 border-t border-gray-300 dark:border-gray-600 my-3 px-4 py-4">
          <div className="flex items-center gap-2">
            <Image src={facebook} alt="facebook" height={18} width={18}
              className="cursor-pointer dark:invert dark:brightness-0 dark:contrast-100" />
            <Image src={instagram} alt="instagram" height={18} width={18}
              className="cursor-pointer dark:invert dark:brightness-0 dark:contrast-100" />
            <Image src={telegram} alt="telegram" height={18} width={18}
              className="cursor-pointer dark:invert dark:brightness-0 dark:contrast-100" />
          </div>
