        ...
        <div className="relative w-full pl-4 xl:pl-0 pr-4 -z-0">
            ...
            <div className="relative z-10 bg-white dark:bg-[#0f1a0f] backdrop-blur-md rounded-2xl shadow-xl max-w-[1000px] mx-auto overflow-hidden transition-colors">
                ...
                {[{
                    ...
                    title: "Buxgalteriya va moliya xisobi bo`limi boshlig’i",
                    phone: "+998 99 870 99 00",
                    email: "UU.Karimov@yashil.uz"
                }, {
                    img: leader2,
                    name: "ALLAYEV UCHQUN TURSUNOVICH",
                    title: "Yuridik bo‘lim boshlig’i",
                            ...
                            <div className="flex flex-col gap-1 text-[15px] text-gray-600 dark:text-gray-300 mt-3">
                                <div className="flex gap-3">
                                    <div className="flex items-center gap-2">
                                        <Image src={call} alt="phone" width={16} height={16} className="dark:invert dark:brightness-0" />
                                        <span>{person.phone}</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <Image src={sms} alt="email" width={16} height={16} className="dark:invert dark:brightness-0" />
                ...
                {/* Footer */}
                <div className="flex justify-between text-gray-500 dark:text-gray-400 border-t dark:border-gray-700 my-3 px-4 py-4">
                    <div className="flex items-center gap-2">
