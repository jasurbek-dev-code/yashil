...
export default function Navigation() {
  ...
  return (
    <div className="bg-[#0d3d0d] flex flex-wrap justify-between py-2 px-2 lg:px-48 gap-12 font-sans">
      <div
      ...
      >
        ...
        >
          Biz haqimizda <span className="text-[22px] ml-1"><Image src={arrowDown} alt="arrow down" height={14} width={14} /></span>
        </div>
        {isHovered && (
          <div className="absolute top-full left-0 mt-0 w-48 transition duration-300 bg-white shadow-lg rounded-md py-2 z-[999]">
            ...
            <Link href="/about/activity" className="block px-4 py-2 text-[#8DC63F] hover:bg-gray-100 text-[16px]">
              Faoliyat
            </Link>
