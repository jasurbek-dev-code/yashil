...
//           <div
//            onClick={toggleTheme}
//            className="w-10 h-10 flex items-center justify-center border-2 border-white rounded-md text-white hover:border-green-900 cursor-pointer transition-colors"
//            >
    ...
    <div className="w-full px-5">
      <header className="max-w-[1200px] mx-auto flex flex-wrap justify-between items-center py-5 bg-transparent">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          {/* Til tanlash */}
          <div className="relative w-16">
            <select className="w-full px-1.5 py-1 text-sm h-10 border-2 border-white dark:border-gray-400 rounded-md text-white dark:text-gray-100 bg-transparent appearance-none focus:outline-none cursor-pointer hover:border-green-900">
              <option className="text-black bg-white" value="uz">O'zb</option>
              <option className="text-black bg-white" value="ru">RU</option>
              <option className="text-black bg-white" value="en">EN</option>
            </select>
          ...
          {/* Qidiruv tugmasi */}
          {/* <div className="w-10 h-10 flex items-center justify-center border-2 border-white dark:border-gray-400 rounded-md text-white dark:text-gray-100 hover:border-green-900 cursor-pointer transition-colors">
            <Image src="/icons/search-normal.svg" alt="search" width={20} height={20} />
          </div> */}

          {/* 👁 Tema almashtirish tugmasi (icon o‘zgarmaydi) */}
          <div
            onClick={toggleTheme}
