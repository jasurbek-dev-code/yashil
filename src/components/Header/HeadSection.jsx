...
export default function HeadSection() {
  ...
  return (
    <div className="bg-transparent px-5 py-[60px] text-center text-white dark:text-gray-100 max-w-[1920px] mx-auto relative">
      ...
      <p className="mt-[50px] text-[16px] max-w-[700px] mx-auto mb-[30px] leading-relaxed opacity-80">
        {t("president_order_date")} <br />
        {t("president_order_description")}
      </p>

      <Link
        href="/about/overview"
        className="bg-[#0d3d0d] dark:bg-gray-900 text-white border-none px-8 py-[12px] text-[16px] rounded-md cursor-pointer mt-[20px] mb-[10px] hover:bg-[#0d3d0d] dark:hover:bg-green-800 transition"
      >
        {t("read_more")}
      </Link>
