...
export default function ServicesCartographicGeoinformation() {
    return (
        <div className="relative w-full pl-4 xl:pl-0 pr-4 -z-0">
            ...
            <div className="relative z-10 bg-white backdrop-blur-md rounded-2xl shadow-xl max-w-[1000px] mx-auto overflow-hidden">
                ...
                <div className="px-6 pt-6 text-sm text-gray-600 flex justify-between">
                    <div>
                        <Link href="/" className="hover:underline">Asosiy</Link> / Kartografik geoaxborot tizimini ishlab chiqish
                    </div>
                ...
                <div className="flex justify-between items-center px-6 py-4 border-b border-gray-300">
                    <h1 className="text-[28px] font-bold text-gray-800">Kartografik geoaxborot tizimini ishlab chiqish</h1>
                </div>
