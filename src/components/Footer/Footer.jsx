...
const Footer = () => {
  return (
    <footer className="bg-green-900 text-white py-10">
      <div className="max-w-[1520px] mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div>
      ...
      <div className="max-w-[1520px] mx-auto mt-10 border-t border-white pt-4 px-4 flex flex-col md:flex-row justify-between text-sm">
